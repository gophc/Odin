...
func NewRBNode[T any](key uintptr, val T) *RBNode[T] {
	return &RBNode[T]{
		Value: val,
		Key:   key,
	}
...
func (tree *RBTree[T]) Get(key uintptr) T {
	node := tree.Root
	for node != nil {
		if key < node.Key {
			node = node.Left
...
func (tree *RBTree[T]) InOrder() []*RBNode[T] {
	var nodes []*RBNode[T]
	var stack []*RBNode[T]
...
func (tree *RBTree[T]) Min() (uintptr, *T) {
	if tree.Root == nil {
		return 0, nil
	}
	node := tree.Root
...
func (tree *RBTree[T]) Max() (uintptr, *T) {
	if tree.Root == nil {
		return 0, nil
	}
	node := tree.Root
...
func (tree *RBTree[T]) ReverseInOrder() []*RBNode[T] {
	var nodes []*RBNode[T]
	var stack []*RBNode[T]
...
// Insert 插入节点
func (tree *RBTree[T]) Insert(key uintptr, value T) {
	tree.Root = tree.insert(tree.Root, key, &value)
	tree.Root.Color = BLACK
	tree.Size++
}

func (tree *RBTree[T]) insert(node *RBNode[T], key uintptr, value *T) *RBNode[T] {
	if node == nil {
		return &RBNode[T]{Key: key, Value: *value, Color: RED}
	}
...
// InsertNode 插入节点 Node
func (tree *RBTree[T]) InsertNode(val *RBNode[T]) {
	tree.Root = tree.insert2(&tree.Root, val.Key, val)
	tree.Root.Color = BLACK
	tree.Size++
}

func (tree *RBTree[T]) insert2(parent **RBNode[T], key uintptr, val *RBNode[T]) *RBNode[T] {
	node := *parent
	if node == nil {
		val.Color = RED
		return val
	...
	if key < node.Key {
		node.Left = tree.insert2(&node.Left, key, val)
	} else if key > node.Key {
		node.Right = tree.insert2(&node.Right, key, val)
	} else {
		// node.Value = *value
...
// rotateLeft 左旋
func (tree *RBTree[T]) rotateLeft(node *RBNode[T]) *RBNode[T] {
	x := node.Right
	node.Right = x.Left
	x.Left = node
	x.Color = node.Color
...
// rotateRight 右旋
func (tree *RBTree[T]) rotateRight(node *RBNode[T]) *RBNode[T] {
	x := node.Left
	node.Left = x.Right
	x.Right = node
	x.Color = node.Color
...
// balance 保持红黑树的平衡
func (tree *RBTree[T]) balance(node *RBNode[T]) *RBNode[T] {
...
// Delete 删除节点
func (tree *RBTree[T]) Delete(key uintptr) {
	var deleted bool
...
func (tree *RBTree[T]) delete(node *RBNode[T], key uintptr) (*RBNode[T], bool) {
	if node == nil {
		return nil, false
	}
...
func (tree *RBTree[T]) moveRedLeft(node *RBNode[T]) *RBNode[T] {
	flipColors(node)
...
func (tree *RBTree[T]) moveRedRight(node *RBNode[T]) *RBNode[T] {
	flipColors(node)
...
func (tree *RBTree[T]) deleteMin(node *RBNode[T]) (*RBNode[T], bool) {
	if node.Left == nil {
		return nil, true
	}
	var deleted bool
...
func (tree *RBTree[T]) min(node *RBNode[T]) *RBNode[T] {
	if node.Left == nil {
		return node
	}
