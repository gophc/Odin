...
func LLVMCreateTypeAttribute(C LLVMContextRef, KindID uint, Ty LLVMTypeRef) LLVMAttributeRef {
	return 0
}
func LLVMCreateStringAttribute(C LLVMContextRef, K string, KLength uint, V string, VLength uint) LLVMAttributeRef {
	return 0
}
...
func LLVMAddAlias(M LLVMModuleRef, T LLVMTypeRef, Aliasee LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMAddAlias2(M LLVMModuleRef, T LLVMTypeRef, AddrSpace uint, Aliasee LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
...
func LLVMAddGlobalInAddressSpace(M LLVMModuleRef, T LLVMTypeRef, Name string, AddressSpace uint) LLVMValueRef {
	return 0
}
...
func LLVMStructType(ElementTypes []LLVMTypeRef, ElementCount uint, Packed LLVMBool) LLVMTypeRef {
	return 0
}
func LLVMStructTypeInContext(C LLVMContextRef, ElementTypes []LLVMTypeRef, ElementCount uint, Packed LLVMBool) LLVMTypeRef {
	return 0
}
...
func LLVMFunctionType(ReturnType LLVMTypeRef, ParamTypes []LLVMTypeRef, ParamCount uint, IsVarArg LLVMBool) LLVMTypeRef {
	return 0
}
...
func LLVMTargetExtType(C LLVMContextRef, Name string, TypeParams []LLVMTypeRef, IntParams []uint) LLVMTypeRef {
	return 0
}
...
func LLVMConstIntOfStringAndSize(IntTy LLVMTypeRef, Text string, SLen uint, Radix uint8) LLVMValueRef {
	return 0
}
...
func LLVMConstStringInContext(C LLVMContextRef, Str string, Length uint, DontNullTerminate LLVMBool) LLVMValueRef {
	return 0
}
func LLVMConstString(Str string, Length uint, DontNullTerminate LLVMBool) LLVMValueRef { return 0 }
func LLVMConstStructInContext(C LLVMContextRef, ConstantVals []LLVMValueRef, Count uint, Packed LLVMBool) LLVMValueRef {
	return 0
}
func LLVMConstStruct(ConstantVals []LLVMValueRef, Count uint, Packed LLVMBool) LLVMValueRef { return 0 }
func LLVMConstArray(ElementTy LLVMTypeRef, ConstantVals []LLVMValueRef, Length uint) LLVMValueRef {
	return 0
}
func LLVMConstArray2(ElementTy LLVMTypeRef, ConstantVals []LLVMValueRef, Length uint) LLVMValueRef {
	return 0
}
func LLVMConstNamedStruct(StructTy LLVMTypeRef, ConstantVals []LLVMValueRef, Count uint) LLVMValueRef {
	return 0
}
...
func LLVMConstICmp(Predicate LLVMIntPredicate, LHSConstant LLVMValueRef, RHSConstant LLVMValueRef) LLVMValueRef {
	return 0
}
func LLVMConstFCmp(Predicate LLVMRealPredicate, LHSConstant LLVMValueRef, RHSConstant LLVMValueRef) LLVMValueRef {
	return 0
}
...
func LLVMConstGEP(Ty LLVMTypeRef, ConstantVal LLVMValueRef, ConstantIndices []LLVMValueRef, NumIndices uint) LLVMValueRef {
	return 0
}
func LLVMConstGEP2(Ty LLVMTypeRef, ConstantVal LLVMValueRef, ConstantIndices []LLVMValueRef, NumIndices uint) LLVMValueRef {
	return 0
}
func LLVMConstInBoundsGEP(Ty LLVMTypeRef, ConstantVal LLVMValueRef, ConstantIndices []LLVMValueRef, NumIndices uint) LLVMValueRef {
	return 0
}
func LLVMConstInBoundsGEP2(Ty LLVMTypeRef, ConstantVal LLVMValueRef, ConstantIndices []LLVMValueRef, NumIndices uint) LLVMValueRef {
	return 0
}
...
func LLVMConstExtractElement(VectorConstant LLVMValueRef, IndexConstant LLVMValueRef) LLVMValueRef {
	return 0
}
func LLVMConstInsertElement(VectorConstant LLVMValueRef, ElementValueConstant LLVMValueRef, IndexConstant LLVMValueRef) LLVMValueRef {
	return 0
}
func LLVMConstShuffleVector(VectorAConstant LLVMValueRef, VectorBConstant LLVMValueRef, MaskConstant LLVMValueRef) LLVMValueRef {
	return 0
}
func LLVMConstExtractValue(AggConstant LLVMValueRef, IdxList []uint, NumIdx uint) LLVMValueRef {
	return 0
}
func LLVMConstInsertValue(AggConstant LLVMValueRef, ElementValueConstant LLVMValueRef, IdxList []uint, NumIdx uint) LLVMValueRef {
	return 0
}
func LLVMBlockAddress(F LLVMValueRef, BB LLVMBasicBlockRef) LLVMValueRef { return 0 }
func LLVMConstPtrAuth(ConstantVal LLVMValueRef, Key uint, Discriminator LLVMValueRef, IsaPointer LLVMValueRef, AuthenticatedPointer LLVMValueRef) LLVMValueRef {
	return 0
}
...
func LLVMGlobalCopyAllMetadata(Global LLVMValueRef, NumEntries *uint) *LLVMValueMetadataEntry {
	return nil
}
...
func LLVMAddGlobalIFunc(M LLVMModuleRef, Name string, AddressSpace uint, Resolver LLVMValueRef) LLVMValueRef {
	return 0
}
...
func LLVMBuildAllocaWithAlignment(B LLVMBuilderRef, Ty LLVMTypeRef, Align uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildArrayAlloca(B LLVMBuilderRef, Ty LLVMTypeRef, Size LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildArrayAllocaWithAlignment(B LLVMBuilderRef, Ty LLVMTypeRef, Size LLVMValueRef, Align uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFree(B LLVMBuilderRef, PointerVal LLVMValueRef) LLVMValueRef { return 0 }
func LLVMBuildLoad(B LLVMBuilderRef, Ty LLVMTypeRef, PointerVal LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildLoad2(B LLVMBuilderRef, T LLVMTypeRef, PointerVal LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildStore(B LLVMBuilderRef, Val LLVMValueRef, Ptr LLVMValueRef) LLVMValueRef { return 0 }
func LLVMBuildGEP(B LLVMBuilderRef, Ty LLVMTypeRef, Pointer LLVMValueRef, Indices []LLVMValueRef, NumIndices uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildGEP2(B LLVMBuilderRef, Ty LLVMTypeRef, Pointer LLVMValueRef, Indices []LLVMValueRef, NumIndices uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildInBoundsGEP(B LLVMBuilderRef, Ty LLVMTypeRef, Pointer LLVMValueRef, Indices []LLVMValueRef, NumIndices uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildInBoundsGEP2(B LLVMBuilderRef, Ty LLVMTypeRef, Pointer LLVMValueRef, Indices []LLVMValueRef, NumIndices uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildStructGEP(B LLVMBuilderRef, Ty LLVMTypeRef, Pointer LLVMValueRef, Index uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildStructGEP2(B LLVMBuilderRef, Ty LLVMTypeRef, Pointer LLVMValueRef, Index uint, Name string) LLVMValueRef {
	return 0
}
...
func LLVMBuildTrunc(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildZExt(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildSExt(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFPToUI(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFPToSI(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildUIToFP(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildSIToFP(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFPTrunc(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFPExt(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildPtrToInt(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildIntToPtr(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildBitCast(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildAddrSpaceCast(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildZExtOrBitCast(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildSExtOrBitCast(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildTruncOrBitCast(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildPointerCast(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildIntCast(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildIntCast2(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, IsSigned LLVMBool, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFPCast(B LLVMBuilderRef, Val LLVMValueRef, DestTy LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
...
func LLVMBuildPtrDiff(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildPtrDiff2(B LLVMBuilderRef, ElemTy LLVMTypeRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildAdd(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildNSWAdd(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildNUWAdd(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFAdd(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildSub(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildNSWSub(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildNUWSub(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFSub(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildMul(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildNSWMul(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildNUWMul(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFMul(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildUDiv(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildExactUDiv(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildSDiv(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildExactSDiv(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFDiv(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildURem(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildSRem(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFRem(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildShl(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildLShr(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildAShr(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildAnd(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildOr(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildXor(B LLVMBuilderRef, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildBinOp(B LLVMBuilderRef, Op LLVMOpcode, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
...
func LLVMBuildICmp(B LLVMBuilderRef, Op LLVMIntPredicate, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFCmp(B LLVMBuilderRef, Op LLVMRealPredicate, LHS LLVMValueRef, RHS LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildPhi(B LLVMBuilderRef, Ty LLVMTypeRef, Name string) LLVMValueRef { return 0 }
func LLVMBuildCall(B LLVMBuilderRef, Fn LLVMValueRef, Args []LLVMValueRef, NumArgs uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildCall2(B LLVMBuilderRef, FnTy LLVMTypeRef, Fn LLVMValueRef, Args []LLVMValueRef, NumArgs uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildSelect(B LLVMBuilderRef, If LLVMValueRef, Then LLVMValueRef, Else LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildVAArg(B LLVMBuilderRef, List LLVMValueRef, Ty LLVMTypeRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildExtractElement(B LLVMBuilderRef, VecVal LLVMValueRef, Index LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildInsertElement(B LLVMBuilderRef, VecVal LLVMValueRef, EltVal LLVMValueRef, Index LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildShuffleVector(B LLVMBuilderRef, V1 LLVMValueRef, V2 LLVMValueRef, Mask LLVMValueRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildExtractValue(B LLVMBuilderRef, AggVal LLVMValueRef, Index uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildInsertValue(B LLVMBuilderRef, AggVal LLVMValueRef, EltVal LLVMValueRef, Index uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildFreeze(B LLVMBuilderRef, Val LLVMValueRef, Name string) LLVMValueRef { return 0 }
func LLVMBuildGEPNoWrap(B LLVMBuilderRef, Ty LLVMTypeRef, Pointer LLVMValueRef, Indices []LLVMValueRef, NumIndices uint, NoWrapFlags LLVMGEPNoWrapFlags, Name string) LLVMValueRef {
	return 0
}
...
func LLVMBuildSwitch(B LLVMBuilderRef, V LLVMValueRef, Else LLVMBasicBlockRef, NumCases uint) LLVMValueRef {
	return 0
}
func LLVMBuildIndirectBr(B LLVMBuilderRef, Addr LLVMValueRef, NumDests uint) LLVMValueRef { return 0 }
func LLVMBuildInvoke(B LLVMBuilderRef, Fn LLVMValueRef, Args []LLVMValueRef, NumArgs uint, Then LLVMBasicBlockRef, Catch LLVMBasicBlockRef, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildInvoke2(B LLVMBuilderRef, FnTy LLVMTypeRef, Fn LLVMValueRef, Args []LLVMValueRef, NumArgs uint, Then LLVMBasicBlockRef, Catch LLVMBasicBlockRef, Name string) LLVMValueRef {
	return 0
}
...
func LLVMBuildLandingPad(B LLVMBuilderRef, Ty LLVMTypeRef, PersFn LLVMValueRef, NumClauses uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildCleanupRet(B LLVMBuilderRef, CleanupPad LLVMValueRef, UnwindBB LLVMBasicBlockRef) LLVMValueRef {
	return 0
}
func LLVMBuildCatchRet(B LLVMBuilderRef, CatchPad LLVMValueRef, BB LLVMBasicBlockRef) LLVMValueRef {
	return 0
}
func LLVMBuildCatchPad(B LLVMBuilderRef, ParentPad LLVMValueRef, Args []LLVMValueRef, NumArgs uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildCleanupPad(B LLVMBuilderRef, ParentPad LLVMValueRef, Args []LLVMValueRef, NumArgs uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildCatchSwitch(B LLVMBuilderRef, ParentPad LLVMValueRef, UnwindBB LLVMBasicBlockRef, NumHandlers uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildCallBr(B LLVMBuilderRef, Fn LLVMValueRef, Args []LLVMValueRef, NumArgs uint, DefaultDest LLVMBasicBlockRef, IndirectDests []LLVMBasicBlockRef, NumIndirectDests uint, IndirectArgs []LLVMValueRef, NumIndirectArgs uint, Name string) LLVMValueRef {
	return 0
}
func LLVMBuildCallBr2(B LLVMBuilderRef, FnTy LLVMTypeRef, Fn LLVMValueRef, Args []LLVMValueRef, NumArgs uint, DefaultDest LLVMBasicBlockRef, IndirectDests []LLVMBasicBlockRef, NumIndirectDests uint, IndirectArgs []LLVMValueRef, NumIndirectArgs uint, Name string) LLVMValueRef {
	return 0
}
...
func LLVMBuildAtomicCmpXchg(B LLVMBuilderRef, Ptr LLVMValueRef, Cmp LLVMValueRef, New LLVMValueRef, SuccessOrdering LLVMAtomicOrdering, FailureOrdering LLVMAtomicOrdering, SingleThread LLVMBool) LLVMValueRef {
	return 0
}
func LLVMBuildAtomicRMW(B LLVMBuilderRef, Op LLVMAtomicRMWBinOp, Ptr LLVMValueRef, Val LLVMValueRef, Ordering LLVMAtomicOrdering, SingleThread LLVMBool) LLVMValueRef {
	return 0
}
func LLVMBuildFence(B LLVMBuilderRef, Ordering LLVMAtomicOrdering, SingleThread LLVMBool, Name string) LLVMValueRef {
	return 0
}
...
func LLVMMDNodeInContext(C LLVMContextRef, MDs []LLVMMetadataRef, Count uint) LLVMMetadataRef {
	return 0
}
...
func LLVMIntPtrTypeForASInContext(C LLVMContextRef, TD LLVMTargetDataRef, AS uint) LLVMTypeRef {
	return 0
}
...
func LLVMCreateTargetMachineWithOptions(T LLVMTargetRef, Triple string, CPU string, Features string, Options LLVMTargetMachineOptionsRef) LLVMTargetMachineRef {
	return 0
}
...
func LLVMGetTargetFromTriple(Triple string, T *LLVMTargetRef, ErrorMessage *string) LLVMBool {
	return 0
}
...
func LLVMTargetMachineEmitToFile(TM LLVMTargetMachineRef, M LLVMModuleRef, Filename string, codegen LLVMCodeGenFileType, ErrorMessage *string) LLVMBool {
	return 0
}
func LLVMTargetMachineEmitToMemoryBuffer(TM LLVMTargetMachineRef, M LLVMModuleRef, codegen LLVMCodeGenFileType, ErrorMessage *string) LLVMMemoryBufferRef {
	return 0
}
...
func LLVMCreateGenericValueOfInt(Ty LLVMTypeRef, N uint64, IsSigned LLVMBool) LLVMGenericValueRef {
	return 0
}
...
func LLVMCreateExecutionEngineForModule(OutEE *LLVMExecutionEngineRef, M LLVMModuleRef, OutError *string) LLVMBool {
	return 0
}
func LLVMCreateInterpreterForModule(OutInterp *LLVMExecutionEngineRef, M LLVMModuleRef, OutError *string) LLVMBool {
	return 0
}
func LLVMCreateJITCompilerForModule(OutJIT *LLVMExecutionEngineRef, M LLVMModuleRef, OptLevel uint, OutError *string) LLVMBool {
	return 0
}
func LLVMInitializeMCJITCompilerOptions(Options *LLVMMCJITCompilerOptions, SizeOfOptions uint) {}
func LLVMCreateMCJITCompilerForModule(OutJIT *LLVMExecutionEngineRef, M LLVMModuleRef, Options *LLVMMCJITCompilerOptions, SizeOfOptions uint, OutError *string) LLVMBool {
	return 0
}
...
func LLVMRunFunctionAsMain(EE LLVMExecutionEngineRef, F LLVMValueRef, ArgC uint, ArgV []*byte, EnvP *byte) int {
	return 0
}
func LLVMRunFunction(EE LLVMExecutionEngineRef, F LLVMValueRef, NumArgs uint, Args []LLVMGenericValueRef) LLVMGenericValueRef {
	return 0
}
...
func LLVMCreateMemoryBufferWithContentsOfFile(Path string, OutMemBuf *LLVMMemoryBufferRef, OutMsg *string) LLVMBool {
	return 0
}
func LLVMCreateMemoryBufferWithSTDIN(OutMemBuf *LLVMMemoryBufferRef, OutMsg *string) LLVMBool {
	return 0
}
func LLVMCreateMemoryBufferWithMemoryRange(InputData string, InputDataLength uint, BufferName string, RequiresNullTerminator LLVMBool) LLVMMemoryBufferRef {
	return 0
}
func LLVMCreateMemoryBufferWithMemoryRangeCopy(InputData string, InputDataLength uint, BufferName string) LLVMMemoryBufferRef {
	return 0
}
...
func LLVMParseIRInContext(ContextRef LLVMContextRef, MemBuf LLVMMemoryBufferRef, OutM *LLVMModuleRef, OutMsg *string) LLVMBool {
	return 0
}
func LLVMParseBitcode(MemBuf LLVMMemoryBufferRef, OutModule *LLVMModuleRef, OutMsg *string) LLVMBool {
	return 0
}
func LLVMParseBitcode2(MemBuf LLVMMemoryBufferRef, OutModule *LLVMModuleRef) LLVMBool { return 0 }
func LLVMParseBitcodeInContext(ContextRef LLVMContextRef, MemBuf LLVMMemoryBufferRef, OutModule *LLVMModuleRef, OutMsg *string) LLVMBool {
	return 0
}
func LLVMParseBitcodeInContext2(ContextRef LLVMContextRef, MemBuf LLVMMemoryBufferRef, OutModule *LLVMModuleRef) LLVMBool {
	return 0
}
func LLVMGetBitcodeModuleInContext(ContextRef LLVMContextRef, MemBuf LLVMMemoryBufferRef, OutM *LLVMModuleRef, OutMsg *string) LLVMBool {
	return 0
}
func LLVMGetBitcodeModuleInContext2(ContextRef LLVMContextRef, MemBuf LLVMMemoryBufferRef, OutM *LLVMModuleRef) LLVMBool {
	return 0
}
func LLVMGetBitcodeModule(MemBuf LLVMMemoryBufferRef, OutM *LLVMModuleRef, OutMsg *string) LLVMBool {
	return 0
}
...
func LLVMWriteBitcodeToFD(M LLVMModuleRef, FD int, ShouldClose LLVMBool, Unbuffered LLVMBool) int {
	return 0
}
...
func LLVMVerifyModule(M LLVMModuleRef, Action LLVMVerifierFailureAction, OutMessage *string) LLVMBool {
	return 0
}
...
func LLVMGetSectionContainsSymbol(SI LLVMSectionIteratorRef, Sym LLVMSymbolIteratorRef) LLVMBool {
	return 0
}
...
func LLVMIsRelocationIteratorAtEnd(SI LLVMSectionIteratorRef, RI LLVMRelocationIteratorRef) LLVMBool {
	return 0
}
...
func LLVMCreateBinary(MemBuf LLVMMemoryBufferRef, Context LLVMContextRef, ErrorMessage *string) LLVMBinaryRef {
	return 0
}
...
func LLVMDIBuilderCreateCompileUnit(Builder LLVMDIBuilderRef, Lang LLVMDWARFSourceLanguage, FileRef LLVMMetadataRef, Producer string, ProducerLen uint, IsOptimized LLVMBool, Flags string, FlagsLen uint, RuntimeVer uint, SplitName string, SplitNameLen uint, Kind LLVMDWARFEmissionKind, DWOId uint, SplitDebugFilename string, SplitDebugFilenameLen uint, DebugInfoForProfiling LLVMBool, SysRoot string, SysRootLen uint, SDK string, SDKLen uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateFile(Builder LLVMDIBuilderRef, Filename string, FilenameLen uint, Directory string, DirectoryLen uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateModule(Builder LLVMDIBuilderRef, ParentScope LLVMMetadataRef, Name string, NameLen uint, ConfigMacros string, ConfigMacrosLen uint, IncludePath string, IncludePathLen uint, ISysRoot string, ISysRootLen uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateNameSpace(Builder LLVMDIBuilderRef, ParentScope LLVMMetadataRef, Name string, NameLen uint, ExportSymbols LLVMBool) LLVMMetadataRef {
	return 0
}
...
func LLVMDIBuilderCreateLexicalBlock(Builder LLVMDIBuilderRef, Scope LLVMMetadataRef, File LLVMMetadataRef, Line uint, Column uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateLexicalBlockFile(Builder LLVMDIBuilderRef, Scope LLVMMetadataRef, File LLVMMetadataRef, Discriminator uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateImportedModule(Builder LLVMDIBuilderRef, Context LLVMMetadataRef, NS LLVMMetadataRef, File LLVMMetadataRef, Line uint, Name string, NameLen uint, Elements []LLVMMetadataRef, NumElements uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateImportedDeclaration(Builder LLVMDIBuilderRef, Context LLVMMetadataRef, Decl LLVMMetadataRef, File LLVMMetadataRef, Line uint, Name string, NameLen uint, Element LLVMMetadataRef) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateEnumerator(Builder LLVMDIBuilderRef, Name string, NameLen uint, Value int64, IsUnsigned LLVMBool) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateEnumerationType(Builder LLVMDIBuilderRef, Scope LLVMMetadataRef, Name string, NameLen uint, File LLVMMetadataRef, LineNumber uint, SizeInBits uint64, AlignInBits uint32, Elements []LLVMMetadataRef, NumElements uint, ClassTy LLVMMetadataRef) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateUnionType(Builder LLVMDIBuilderRef, Scope LLVMMetadataRef, Name string, NameLen uint, File LLVMMetadataRef, LineNumber uint, SizeInBits uint64, AlignInBits uint32, Flags LLVMDIFlags, Elements []LLVMMetadataRef, NumElements uint, RunTimeLang uint, UniqueId string, UniqueIdLen uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateArrayType(Builder LLVMDIBuilderRef, Size uint64, AlignInBits uint32, Ty LLVMMetadataRef, Subscripts []LLVMMetadataRef, NumSubscripts uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateVectorType(Builder LLVMDIBuilderRef, Size uint64, AlignInBits uint32, Ty LLVMMetadataRef, Subscripts []LLVMMetadataRef, NumSubscripts uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateBasicType(Builder LLVMDIBuilderRef, Name string, NameLen uint, SizeInBits uint64, Encoding LLVMDWARFTypeEncoding, Flags LLVMDIFlags) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreatePointerType(Builder LLVMDIBuilderRef, PointeeTy LLVMMetadataRef, SizeInBits uint64, AlignInBits uint32, AddressSpace uint, Name string, NameLen uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateStructType(Builder LLVMDIBuilderRef, Scope LLVMMetadataRef, Name string, NameLen uint, File LLVMMetadataRef, LineNumber uint, SizeInBits uint64, AlignInBits uint32, Flags LLVMDIFlags, DerivedFrom LLVMMetadataRef, Elements []LLVMMetadataRef, NumElements uint, RunTimeLang uint, VTableHolder LLVMMetadataRef, UniqueId string, UniqueIdLen uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateMemberType(Builder LLVMDIBuilderRef, Scope LLVMMetadataRef, Name string, NameLen uint, File LLVMMetadataRef, LineNo uint, SizeInBits uint64, AlignInBits uint32, OffsetInBits uint64, Flags LLVMDIFlags, Ty LLVMMetadataRef) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateUnspecifiedType(Builder LLVMDIBuilderRef, Name string, NameLen uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateStaticMemberType(Builder LLVMDIBuilderRef, Scope LLVMMetadataRef, Name string, NameLen uint, File LLVMMetadataRef, LineNumber uint, Ty LLVMMetadataRef, Flags LLVMDIFlags, ConstantVal LLVMValueRef, AlignInBits uint32) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateObjCIVar(Builder LLVMDIBuilderRef, Name string, NameLen uint, File LLVMMetadataRef, LineNo uint, SizeInBits uint64, AlignInBits uint32, OffsetInBits uint64, Flags LLVMDIFlags, Ty LLVMMetadataRef, PropertyNode LLVMMetadataRef) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateObjCProperty(Builder LLVMDIBuilderRef, Name string, NameLen uint, File LLVMMetadataRef, LineNo uint, GetterName string, GetterNameLen uint, SetterName string, SetterNameLen uint, PropertyAttributes uint, Ty LLVMMetadataRef) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateObjectPointerType(Builder LLVMDIBuilderRef, Ty LLVMMetadataRef) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateQualifiedType(Builder LLVMDIBuilderRef, Tag uint, Ty LLVMMetadataRef) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateReferenceType(Builder LLVMDIBuilderRef, Tag uint, Ty LLVMMetadataRef) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateNullPtrType(Builder LLVMDIBuilderRef) LLVMMetadataRef { return 0 }
func LLVMDIBuilderCreateSubroutineType(Builder LLVMDIBuilderRef, File LLVMMetadataRef, ParameterTypes []LLVMMetadataRef, NumParameterTypes uint, Flags LLVMDIFlags) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateMacro(Builder LLVMDIBuilderRef, ParentMacroFile LLVMMetadataRef, Line uint, RecordType LLVMDWARFMacinfoRecordType, Name string, NameLen uint, Value string, ValueLen uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateTempMacroFile(Builder LLVMDIBuilderRef, ParentMacroFile LLVMMetadataRef, Line uint, File LLVMMetadataRef) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateDebugLocation(Line uint, Column uint, Scope LLVMMetadataRef, InlinedAt LLVMMetadataRef) LLVMMetadataRef {
	return 0
}
...
func LLVMDIBuilderCreateExpression(Builder LLVMDIBuilderRef, Value []uint64, NumElements uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateConstantValueExpression(Builder LLVMDIBuilderRef, Value string, ValueLen uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateGlobalVariableExpression(Builder LLVMDIBuilderRef, Scope LLVMMetadataRef, Name string, NameLen uint, LinkageName string, LinkageNameLen uint, File LLVMMetadataRef, LineNo uint, Ty LLVMMetadataRef, IsLocalToUnit LLVMBool, Val LLVMValueRef, DIExpr LLVMMetadataRef, Decl LLVMMetadataRef, AlignInBits uint32) LLVMMetadataRef {
	return 0
}
...
func LLVMDIBuilderGetOrCreateTypeArray(Builder LLVMDIBuilderRef, Types []LLVMMetadataRef, Length uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderGetOrCreateSubrange(Builder LLVMDIBuilderRef, LowerBound int64, Count int64) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderGetOrCreateArray(Builder LLVMDIBuilderRef, Data []LLVMMetadataRef, Length uint) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderInsertDeclareAtEnd(Builder LLVMDIBuilderRef, Storage LLVMValueRef, VarInfo LLVMMetadataRef, DIExpr LLVMMetadataRef, DILocation LLVMMetadataRef, Block LLVMBasicBlockRef) LLVMDbgRecordRef {
	return 0
}
func LLVMDIBuilderInsertValueAtEnd(Builder LLVMDIBuilderRef, Val LLVMValueRef, DIExpr LLVMMetadataRef, DILocation LLVMMetadataRef, Block LLVMBasicBlockRef) LLVMDbgRecordRef {
	return 0
}
func LLVMDIBuilderInsertDbgValueBefore(Builder LLVMDIBuilderRef, Val LLVMValueRef, DIExpr LLVMMetadataRef, DILocation LLVMMetadataRef, Instr LLVMValueRef) LLVMDbgRecordRef {
	return 0
}
func LLVMDIBuilderInsertDbgValueAtEnd(Builder LLVMDIBuilderRef, Val LLVMValueRef, DIExpr LLVMMetadataRef, DILocation LLVMMetadataRef, Block LLVMBasicBlockRef) LLVMDbgRecordRef {
	return 0
}
func LLVMDIBuilderInsertDeclareBefore(Builder LLVMDIBuilderRef, Storage LLVMValueRef, DIExpr LLVMMetadataRef, DILocation LLVMMetadataRef, Instr LLVMValueRef) LLVMDbgRecordRef {
	return 0
}
func LLVMDIBuilderCreateAutoVariable(Builder LLVMDIBuilderRef, Scope LLVMMetadataRef, Name string, NameLen uint, File LLVMMetadataRef, LineNo uint, Ty LLVMMetadataRef, AlwaysPreserve LLVMBool, Flags LLVMDIFlags, AlignInBits uint32) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderCreateParameterVariable(Builder LLVMDIBuilderRef, Scope LLVMMetadataRef, Name string, NameLen uint, ArgNo uint, File LLVMMetadataRef, LineNo uint, Ty LLVMMetadataRef, AlwaysPreserve LLVMBool, Flags LLVMDIFlags, AlignInBits uint32) LLVMMetadataRef {
	return 0
}
func LLVMDIBuilderGetFlag(Builder LLVMDIBuilderRef, Name string, NameLen uint) LLVMDIFlags { return 0 }
func LLVMDIBuilderCreateReplaceableCompositeType(Builder LLVMDIBuilderRef, Tag uint, Name string, NameLen uint, Scope LLVMMetadataRef, File LLVMMetadataRef, Line uint, RuntimeLang uint, SizeInBits uint64, AlignInBits uint32, Flags LLVMDIFlags, UniqueIdentifier string, UniqueIdentifierLen uint) LLVMMetadataRef {
	return 0
}
...
func LLVMRunPasses(M LLVMModuleRef, Passes string, MRef LLVMTargetMachineRef, Options LLVMPassBuilderOptionsRef) LLVMErrorRef {
	return 0
}
